...
public class GetProductByIdUseCase(IProductRepository repository, IStorageService storageService)
    : GetByIdUseCaseBase<Product, IProductRepository, ProductResponseDto>(repository)
{
